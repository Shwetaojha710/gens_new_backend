...
const { createEmp, getEmp, updateEmp, deleteEmp, uploadImage, getUploadedImage, employeeList, RegisterAppEmp, AppemployeeList } = require('../controller/tenant/empPersonal');
